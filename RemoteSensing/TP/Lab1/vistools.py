...
def clickablemap(center = [48.790153, 2.327395], zoom = 13,
                 layout = ipywidgets.Layout(width='90%', height='500px') ):
 ...
 #   %matplotlib notebook
    ...
    def handle_draw(self, action, geo_json):
        ...
        m.AOIs.append(geo_json["geometry"])
